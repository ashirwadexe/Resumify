    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12 pb-20'>
            ...
            <Title 
                ...
                description='Everything you need to manage, share, and edit your resume, securely and efficiently.'
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-15">
                ...
                <div className="flex flex-col items-center justify-center max-w-80">
                    ...
                    <div className="mt-5 space-y-2 text-center">
                        ...
                        <p className="text-sm text-slate-600">AI automatically improves your resume content for clarity, keywords, and ATS-friendly formatting.</p>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center max-w-80">
                    ...
                    <div className="mt-5 space-y-2 text-center">
                        ...
                        <p className="text-sm text-slate-600">Build and manage multiple resumes using modern templates with live editing and preview.</p>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center max-w-80">
                    ...
                    <div className="mt-5 space-y-2 text-center">
                        ...
                        <p className="text-sm text-slate-600">Instantly generate a shareable resume link, download pdf and preview your resume online anytime.</p>
                    </div>
                </div>
            </div>
        </div>
