    ...
    <div>
        <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white">
            <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-2">
                        ...
                        <li><a href="/cta" className="hover:text-green-600 transition">Support</a></li>
            ...
            <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                ...
                <p className="mt-3 text-center hover:text-green-500">© 2025 <a href="https://ashirwadexe.netlify.app/" target='_blank' className='hover:underline'>Ashirwad🥳</a></p>
            </div>
        </footer>
    </div>
  )
