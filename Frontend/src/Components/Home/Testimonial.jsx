...
const Testimonial = () => {
    ...
    return (
        <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12 pb-20'>
            ...
            <Title 
                ...
                description='Discover why users trust Resumify to build and optimize their resumes.'
            />
