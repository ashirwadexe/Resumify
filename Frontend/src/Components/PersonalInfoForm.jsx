  ...
  return (
    <div>
        ...
        <div className='flex items-center gap-2'>
            ...
            {/* REMOVE BG TOGGLE BUTTON */}
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm'>
                    <p className='text-xs'>Remove Background</p>
        ...
        {feilds.map((feild) => {
            ...
            return (
                <div key={feild.key} className='space-y-1 mt-5'>
                    ...
                    <input 
                        type={feild.type} 
                        value={data[feild.key] || ""} 
                        onChange={(e) => handleChange(feild.key, e.target.value)} 
                        ...
                        placeholder={`Enter your ${feild.label.toLowerCase()}`}
