  ...
  return (
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
            <div>
                <h3 className='flex items-center gap-2 text-lg font-semibold text-shadow-gray-900'>Professional Summary</h3>
        ...
        <div className='mt-6'>
            <textarea 
                ...
                placeholder='Write a complelling professional summary that highlights your key strengths and career objectives...'
            />
